...
<link href="{{ asset('assets/vendor/css/pages/front-page.css?v=1.0.4') }}" rel="stylesheet" />
...
<link href="{{ asset('assets/vendor/css/pages/front-page-landing.css?v=1.0.4') }}" rel="stylesheet" />
